! function() {
    ...
    let i = function() {
        let e = {
            ...
            o = null,
            l = null,
            s = "https://staging-api.chainit.online",
            d = null,
            u = null,
            f = null,
            R = null,
            ...
            p = (i, t, r, c = []) => {
                ...
                return t === n.POST && (a.body = JSON.stringify(r)), fetch(i, a).then(e => e.json()).then(e => (b(i, t, r, e), e)).catch(e => {
                    console.error(e)
                })
            },
            y = e => {
      ...
      `;
            ...
            $ = () => {
                m(), p(`${v("/users/v1/age-verification")}`, n.POST, {}, {
                    [i]: c
                }).then(e => {
                    q(e.qrCodeUrl, e.deepLink), j(e.qrCodeStatusCheckUrl)
                })
            };
        return {
            configure: T,
